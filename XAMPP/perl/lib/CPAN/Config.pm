...
if ( -d 'H:\\Project\\churuata\\XAMPP\\minicpan' ) {
  ...
  unless ( $@ ) {
    if ( LWP::Online::online() ) {
      push @urllist, q[file:///H:/Project/churuata/XAMPP/minicpan/];
    } else {
      unshift @urllist, q[file:///H:/Project/churuata/XAMPP/minicpan/];
    }
  }
}
...
$CPAN::Config = {
  ...
  auto_commit                   => q[1],
  build_cache                   => q[50],
  build_dir                     => q[H:\\Project\\churuata\\XAMPP\\cpan\\build],
  build_dir_reuse               => q[0],
  ...
  cpan_home                     => q[H:\\Project\\churuata\\XAMPP\\cpan],
  curl                          => q[],
  ...
  halt_on_failure               => q[1],
  histfile                      => q[H:\\Project\\churuata\\XAMPP\\cpan\\histfile],
  histsize                      => q[1000],
  http_proxy                    => q[],
  inactivity_timeout            => q[0],
  index_expire                  => q[1],
  inhibit_startup_message       => q[0],
  keep_source_where             => q[H:\\Project\\churuata\\XAMPP\\cpan\\sources],
  load_module_verbosity         => q[none],
  lynx                          => q[],
  make                          => q[H:\\Project\\churuata\\XAMPP\\c\\bin\\gmake.exe],
  make_arg                      => q[],
  make_install_arg              => q[UNINST=1],
  make_install_make_command     => q[H:\\Project\\churuata\\XAMPP\\c\\bin\\gmake.exe],
  makepl_arg                    => q[],
  mbuild_arg                    => q[],
  ...
  patch                         => q[H:\\Project\\churuata\\XAMPP\\c\\bin\\patch.exe],
  perl5lib_verbosity            => q[none],
  prefer_external_tar           => q[0],
  prefer_installer              => q[MB],
  prefs_dir                     => q[H:\\Project\\churuata\\XAMPP\\cpan\\prefs],
